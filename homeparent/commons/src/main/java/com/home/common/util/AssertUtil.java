...
public class AssertUtil {
    ...
    public static void assertNotNull(Object o, ResCodeEnum code, String msg) {
    ...
    public static void assertNotNull(Object o, ResCodeEnum code, String format, Object... args) {
    ...
    public static void assertTrue(boolean condition, String msg) {
        assertTrue(condition, ResCodeEnum.ERROR, msg);
    }

    public static void assertTrue(boolean condition, ResCodeEnum codeEnum, String msg) {
        assertTrue(condition, codeEnum, LogLevelEnum.INFO, msg);
    }

    public static void assertTrue(boolean condition, ResCodeEnum codeEnum, LogLevelEnum logLevel, String msg) {
        if (!condition) {
            throw new HomeException(codeEnum.getCode(), msg, logLevel);
        }
    }
    ...
    public static void assertTrue(boolean condition, ResCodeEnum code, String format, Object... args) {
        assertTrue(condition, code, String.format(format, args));
    }

    public static void assertTrue(boolean condition, ResCodeEnum code, LogLevelEnum logLevel, String format, Object... args) {
    ...
    public static void assertFalse(boolean condition, String msg) {
        assertFalse(condition, ResCodeEnum.ERROR, msg);
    }

    public static void assertFalse(boolean condition, ResCodeEnum code, String msg) {
        assertFalse(condition, code, LogLevelEnum.INFO, msg);
    }

    public static void assertFalse(boolean condition, ResCodeEnum code, LogLevelEnum logLevel, String msg) {
    ...
    public static void assertFalse(boolean condition, ResCodeEnum code, String format, Object... args) {
    ...
    public static void assertNotBlank(String str, String msg) {
        assertNotBlank(str, ResCodeEnum.ERROR, msg);
    }

    public static void assertNotBlank(String str, ResCodeEnum code, String msg) {
        assertTrue(!StringUtils.isEmpty(str), code, msg);
    }

    public static void assertNotBlank(String str, String format, Object... args) {
        assertNotBlank(str, ResCodeEnum.ERROR, format, args);
    }

    public static void assertNotBlank(String str, ResCodeEnum code, String format, Object... args) {
    ...
    public static void assertNotEmpty(Collection<?> collection, ResCodeEnum code, String msg) {
    ...
    public static void assertNotEmpty(Collection<?> collection, ResCodeEnum code, String format, Object... args) {
        assertNotEmpty(collection, code, String.format(format, args));
    }

    public static void assertNotEmpty(Collection<?> collection, ResCodeEnum code, LogLevelEnum logLevel, String format, Object... args) {
    ...
    public static void assertBlank(String str, ResCodeEnum code, String msg) {
        assertTrue(StringUtils.isEmpty(str), code, msg);
    }
